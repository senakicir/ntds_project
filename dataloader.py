...
def save_features_labels_adjacency(use_PCA = True, use_eigenmaps = False, rem_disconnected = True, threshold = 0.66, metric = "correlation",use_features = ['mfcc'], dataset_size = 'small',genres=None,num_classes=None, return_features=False,plot_graph=False, train=True,use_mlp=False,use_cpu=False,prefix=""):
    ...
    name = form_file_names(use_PCA, use_eigenmaps, rem_disconnected, dataset_size, threshold,use_mlp,prefix)
